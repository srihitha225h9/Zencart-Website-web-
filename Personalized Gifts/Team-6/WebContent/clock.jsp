...
<%@ page import="newpack.clock" %>
<%@ page import="java.util.List" %>
<%@ page import="newpack.clocksql" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
       ...
       <div class="slider">
    <% 
        clocksql sqlClock = new clocksql();
        List<clock> listClocks = sqlClock.getClocks();
    ...
    <div class="card">
        <div class="card-content">
            <a href="menu.html"> <!-- Replace with appropriate links or actions -->
                <img src="<%= clock.getImageUrl() %>" alt="Clock Image" class="card-img">
            </a>
            <figcaption><%= clock.getCaption() %></figcaption>
            <div class="card-price">
                <i class="fas fa-indian-rupee-sign"></i> <%= clock.getPrice() %>
            </div>
            <div class="rating">★ <%= clock.getRating() %></div>
