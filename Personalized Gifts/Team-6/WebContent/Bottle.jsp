...
<%@ page import="newpack.Bottle" %>
<%@ page import="java.util.List" %>
<%@ page import="newpack.bottlesql" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
       ...
       <div class="slider">
    <% 
        bottlesql sqlBottle = new bottlesql();
        List<Bottle> listBottles = sqlBottle.getBottles();
        
        if (!listBottles.isEmpty()) {
            for (Bottle bottle : listBottles) { 
    %>
    <div class="card">
        <div class="card-content">
            <a href="menu.html"> <!-- Replace with appropriate links or actions -->
                <img src="<%= bottle.getImageUrl() %>" alt="Bottle Image" class="card-img">
            </a>
            <figcaption><%= bottle.getCaption() %></figcaption>
            <div class="card-price">
                <i class="fas fa-indian-rupee-sign"></i> <%= bottle.getPrice() %>
            </div>
            <div class="rating">★ <%= bottle.getRating() %></div>
