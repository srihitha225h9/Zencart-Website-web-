...
<%@ page import="newpack.keychain" %>
<%@ page import="java.util.List" %>
<%@ page import="newpack.keychainsql" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
       ...
       <div class="slider">
    <% 
        keychainsql sqlKeychain = new keychainsql();
        List<keychain> listKeychains = sqlKeychain.getKeychains();
        
        if (!listKeychains.isEmpty()) {
            for (keychain keychain : listKeychains) { 
    %>
    <div class="card">
        <div class="card-content">
            <a href="menu.html"> <!-- Replace with appropriate links or actions -->
                <img src="<%= keychain.getImageUrl() %>" alt="Keychain Image" class="card-img">
            </a>
            <figcaption><%= keychain.getCaption() %></figcaption>
            <div class="card-price">
                <i class="fas fa-indian-rupee-sign"></i> <%= keychain.getPrice() %>
            </div>
            <div class="rating">★ <%= keychain.getRating() %></div>
