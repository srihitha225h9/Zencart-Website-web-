...
<%@ page import="newpack.cushion" %>
<%@ page import="java.util.List" %>
<%@ page import="newpack.cushionsql" %>
<!DOCTYPE html>
<html>
<head>
...
<body>
       ...
       <div class="slider">
    <% 
        cushionsql sqlCon = new cushionsql();
        List<cushion> listCushions = sqlCon.getCushions();
        
        if (!listCushions.isEmpty()) {
            for (cushion cushion : listCushions) { 
    %>
    <div class="card">
        <div class="card-content">
            <a href="menu.html"> <!-- Replace with appropriate links or actions -->
                <img src="<%= cushion.getImageUrl() %>" alt="Cushion Image" class="card-img">
            </a>
            <figcaption><%= cushion.getCaption() %></figcaption>
            <div class="card-price">
                <i class="fas fa-indian-rupee-sign"></i> <%= cushion.getPrice() %>
            </div>
            <div class="rating">★ <%= cushion.getRating() %></div>
